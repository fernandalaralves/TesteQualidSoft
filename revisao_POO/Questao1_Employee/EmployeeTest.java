...
public class EmployeeTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%s %s: R$ %.2f%n", emp1.getNome(), emp1.getUltimoNome(), emp1.getSalarioMensal() * 12);
        System.out.printf("%s %s: R$ %.2f%n", emp2.getNome(), emp2.getUltimoNome(), emp2.getSalarioMensal() * 12);
